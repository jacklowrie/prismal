...
# Script for bootstrapping local environment. Note
# That this installs dev dependencies, since that is
# the default behavior of uv. If you just want to run
# or reproduce an existing experiment, use bootstrap-run.sh
